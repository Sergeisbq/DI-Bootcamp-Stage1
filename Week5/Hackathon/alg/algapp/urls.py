...
from . import views
from .views import add_customer_view, all_rest, rest, one_rest, add_rest_view
#from_one_rest_to #choose_dish, get_cust_and_rest
...
urlpatterns = [
    ...
    path("restaurant/<int:r_id>", one_rest, name='restaurant'), #one_rest
